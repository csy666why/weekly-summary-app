...
/* 任命/撤销管理员空间 */
function setAdmin(spaceId, isAdmin) {
  const sp2 = findById(spaceId);
  if (!sp2) return false;
  sp2.isAdmin = !!isAdmin;
  persist();
  return true;
...
module.exports = { reload, findByName, findById, findByCode, create, verifyPin, setOwner, list, any, first, hashPin, setAdmin };
