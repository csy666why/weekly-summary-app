...
const DEFAULTS = {
  ...
  access: {
    ...
    adminDeviceIds: []   // 额外管理员设备ID（除第一个空间创建者外）
  }
};
...
function publicConfig(cfg) {
  ...
  return {
    ...
    ai: {
      ...
      imageProvider: (cfg.ai && cfg.ai.imageProvider) || "pollinations",
      imageModel: (cfg.ai && cfg.ai.imageModel) || "",
      imageKeySet: !!((cfg.ai && cfg.ai.imageApiKey) || ""),
      keySet: !!key,
